...
- **Always lock Codex Preview to desktop viewport (1440×900) when running `preview_start` / `preview_resize`** — never verify `apps/web` at mobile or tablet widths unless explicitly asked.

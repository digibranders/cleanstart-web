...
const CARDS: readonly [WhyCard, WhyCard, WhyCard, WhyCard] = [
  {
    ...
    imgSrc: '/images/ciso/risks-icon-bloated.webp',
  ...
  },
  {
    ...
    imgSrc: '/images/ciso/risks-icon-inherited.webp',
  ...
  },
  {
    ...
    imgSrc: '/images/ciso/risks-icon-attack.webp',
  ...
  },
  {
    ...
    imgSrc: '/images/ciso/risks-icon-backlogs.webp',

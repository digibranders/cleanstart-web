      ...
      <div className="relative z-[2] mx-auto max-w-[var(--container-default)] px-6 sm:px-10 pt-[calc(clamp(112px,10vw,140px)+var(--cs-header-extra))] pb-[clamp(110px,13vw,190px)]">
        <div className="flex flex-col items-center text-center gap-7">
          ...
          <HeroReveal y={30} delay={0.15} duration={0.8}>
            ...
            >
              From community-ready images to enterprise-grade software supply
              chain security.
            </p>
          </HeroReveal>
...
/** Official AWS "smile" logo (Simple Icons), inherits currentColor. */
function AwsMark(): React.ReactElement {
  return (
    <svg
      width="26"
      height="26"

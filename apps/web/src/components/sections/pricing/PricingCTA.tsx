...
/**
 * Inner content for the pricing CTA card, rendered inside the Footer's fixed
 * radius-40 slot. Mirrors the SBOM CTA style and colors (deep blue→purple
 * gradient, lavender blur glows, cube decoration). The card is taller than the
 * slot, so its bottom is clipped.
 */
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Our team can help you choose the right combination of images, libraries,
            discovery, and deployment assets.
          </p>
          <Link
            href="/contact-us"

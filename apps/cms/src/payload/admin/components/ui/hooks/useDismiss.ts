...
/**
 * Click-outside + ESC dismissal for non-modal floating UI (popovers,
 * menus). Native `<dialog>.showModal()` already handles both for modal
 * surfaces, so don't reach for this in Dialog / Drawer.
 */

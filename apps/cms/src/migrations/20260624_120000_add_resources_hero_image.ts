...
// Adds the optional `heroImage` upload field (relationTo: media) to the
// `resources` collection — column on both the live table and the drafts
// version table, mirroring the heroImage shape every other content
// collection already uses (blogs / news / guides / events / knowledgeBase).

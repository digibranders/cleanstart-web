...
| 13 | Financial Services | `/financial-services` | Static | ✅ | Built from the client proposal docx. **Live and indexable** as of client sign-off: `index,follow`, in the sitemap's `STATIC_ROUTES`, nav-linked (Solutions › By industry), breadcrumb + `JsonLdGraph` in place, 6h ISR. |

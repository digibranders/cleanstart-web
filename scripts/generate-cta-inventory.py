...
ROWS = [
    ...
    ("/", "Footer CTA", "Book a Demo", "/book-a-demo", "/book-a-demo", "Keep — already correct"),
    ("/cleansight", "Hero", "Book a Demo", "/contact-us", "/book-a-demo?product=cleansight", "Commercial intent — route to demo, not generic contact"),
    ...
    ("/teams", "Hero", "(no CTA present)", "—", "Add: 'Book a Demo' → /book-a-demo", "Hero currently has no CTA — add primary"),
    ...
    ("/fips", "Footer CTA", "Book a Demo", "/book-a-demo", "/book-a-demo?product=fips", "Add product tag for routing"),
    ...
    ("/partners", "Hero", "Book a Demo", "/book-a-demo", "/book-a-demo", "Keep"),
